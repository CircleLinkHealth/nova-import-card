...
class ImportAllergies extends Action
{
    ...
    {
        Excel::import(new Allergies($fields->practice_id), $fields->file);
    ...
    {
        return __('Import Practice Pull Allergies');
    }

    public function uriKey(): string
    {
        return 'import-practice-pull-allergies';
    }
}
