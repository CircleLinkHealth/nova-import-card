...
class DatamonitorService
{
    ...
    public function get_alert_msg_info(
        ...
        if ($alert_msg_id == 'CF_AL_01') {
            ...
            if ($alert_msg_id == 'CF_AL_02') {
                $alert_sort_weight = 9;
                $alert_level = 'danger';
            } else {
                if ($alert_msg_id == 'CF_AL_03') {
                    $alert_sort_weight = 9;
                    $alert_level = 'danger';
                } else {
                    if ($alert_msg_id == 'CF_AL_04') {
                        $alert_sort_weight = 9;
                        $alert_level = 'danger';
                    } else {
                        if ($alert_msg_id == 'CF_AL_05') {
                            $alert_sort_weight = 9;
                            $alert_level = 'danger';
                        } else {
                            if ($alert_msg_id == 'CF_AL_06') {
                                $alert_sort_weight = 9;
                                $alert_level = 'danger';
                            } else {
                                if ($alert_msg_id == 'CF_AL_07') {
                                    $alert_sort_weight = 7;
                                    $alert_level = 'danger';
                                } else {
                                    if ($alert_msg_id == 'CF_AL_08') {
                                        $alert_sort_weight = 9;
                                        $alert_level = 'danger';
                                    } else {
                                        if ($alert_msg_id == 'CF_AL_09') {
                                            $alert_sort_weight = 3;
                                            $alert_level = 'warning';
                                        } else {
                                            if ($alert_msg_id == 'CF_AL_10') {
                                                $alert_sort_weight = 3;
                                                $alert_level = 'warning';
                                            } else {
                                                if ($alert_msg_id == 'CF_AL_11') {
                                                    $alert_sort_weight = 3;
                                                    $alert_level = 'warning';
                                                } else {
                                                    if ($alert_msg_id == 'CF_AL_12') {
                                                        $alert_sort_weight = 3;
                                                        $alert_level = 'warning';
                                                    } else {
                                                        if ($alert_msg_id == 'CF_AL_13') {
                                                            $alert_sort_weight = 5;
                                                            $alert_level = 'warning';
                                                        } else {
                                                            if ($alert_msg_id == 'CF_AL_14') {
                                                                $alert_sort_weight = 5;
                                                                $alert_level = 'warning';
                                                            } else {
                                                                if ($alert_msg_id == 'CF_AL_15') {
                                                                    $alert_sort_weight = 5;
                                                                    $alert_level = 'warning';
                                                                } else {
                                                                    if ($alert_msg_id == 'CF_AL_16') {
                                                                        $alert_sort_weight = 5;
                                                                        $alert_level = 'warning';
                                                                    } else {
                                                                        if ($alert_msg_id == 'CF_AL_17') {
                                                                            $alert_sort_weight = 5;
                                                                            $alert_level = 'warning';
                                                                        } else {
                                                                            if ($alert_msg_id == 'CF_AL_18') {
                                                                                $alert_sort_weight = 5;
                                                                                $alert_level = 'warning';
                                                                            } else {
                                                                                if ($alert_msg_id == 'CF_AL_19') {
                                                                                    $alert_sort_weight = 5;
                                                                                    $alert_level = 'warning';
                                                                                } else {
                                                                                    if ($alert_msg_id == 'CF_AL_20') {
                                                                                        $alert_sort_weight = 5;
                                                                                        $alert_level = 'warning';
                                                                                    } else {
                                                                                        if ($alert_msg_id == 'CF_AL_21') {
                                                                                            $alert_sort_weight = 5;
                                                                                            $alert_level = 'warning';
                                                                                        } else {
                                                                                            if ($alert_msg_id == 'CF_AL_22') {
                                                                                                $alert_sort_weight = 5;
                                                                                                $alert_level = 'danger';
                                                                                            } else {
                                                                                                if ($alert_msg_id == 'CF_AL_23') { // HSP_ER + C
                                                                                                    $alert_sort_weight = 7;
                                                                                                    $alert_level = 'warning';
                                                                                                } else {
                                                                                                    if ($alert_msg_id == 'CF_AL_24') { // HSP_ER + mm/dd
                                                                                                        $alert_sort_weight = 7;
                                                                                                        $alert_level = 'warning';
                                                                                                    } else {
                                                                                                        if ($alert_msg_id == 'CF_AL_25') { // HSP_HOSP + c
                                                                                                            $alert_sort_weight = 7;
                                                                                                            $alert_level = 'warning';
                                                                                                        } else {
                                                                                                            if ($alert_msg_id == 'CF_AL_26') { // HSP_HOSP + mm/dd
                                                                                                                $alert_sort_weight = 7;
                                                                                                                $alert_level = 'warning';
                                                                                                            }
                                                                                                        }
