        ...
        if ($assessment) {
            if (!$this->exists($assessment->careplan_id)) {
                ...
                $savedAssessments->update([
                    ...
                    'diabetes_screening_last_and_next_date' => $assessment->diabetes_screening_last_and_next_date,
                    'diabetes_screening_risk' => $assessment->diabetes_screening_risk,
                    'eye_screening_last_and_next_date' => $assessment->eye_screening_last_and_next_date,
