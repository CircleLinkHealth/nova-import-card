...
class EnrolleeForCaPanel
{
    ...
    public static function getArray(Enrollee $enrollee): array
    {
        return (new static($enrollee))->toArray();
    }
    ...
    public function toArray(): array
    {
        ...
        $careAmbassador = $enrollable->careAmbassador->careAmbassador;
    ...
    private function getProviderPhone($enrollable)
    {
        ...
        return (new StringManipulation())->formatPhoneNumberWithBrackets($phone);
    }
