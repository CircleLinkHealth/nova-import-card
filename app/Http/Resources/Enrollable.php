...
class Enrollable extends Resource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'reason'           => Enrollee::UNREACHABLE !== $enrollable->status && $enrollable->last_call_outcome ? $enrollable->last_call_outcome : '',
            'utc_reason_other' => Enrollee::UNREACHABLE === $enrollable->status && $enrollable->last_call_outcome_reason ? $enrollable->last_call_outcome_reason : '',
            'reason_other'     => Enrollee::UNREACHABLE !== $enrollable->status && $enrollable->last_call_outcome_reason ? $enrollable->last_call_outcome_reason : '',
