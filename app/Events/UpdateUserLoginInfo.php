...
class UpdateUserLoginInfo
{
    ...
    public function handle(Login $event)
    {
        ...
        LogSuccessfulLoginToDB::dispatch($event->user)->onQueue(\CircleLinkHealth\Customer\CpmConstants::LOW_QUEUE);
        PostLoginTasks::dispatch($event->user)->onQueue(\CircleLinkHealth\Customer\CpmConstants::LOW_QUEUE);
    }
}
