...
class ProblemsParser extends BaseParser implements Parser
{
    ...
    private function consolidateProblemInfo($ccdProblem)
    {
        ...
        if ( empty($consolidatedProblem->code) && !empty($ccdProblem->translation->code) ) {
            $consolidatedProblem->code = $ccdProblem->translation->code;
        }

        if ( empty($consolidatedProblem->code_system) && !empty($ccdProblem->translation->code_system) ) {
            $consolidatedProblem->code_system = $ccdProblem->translation->code_system;
        }

        if ( empty($consolidatedProblem->code_system_name) && !empty($ccdProblem->translation->code_system_name) ) {
