<?php namespace App\CLH\CCD\Parser;
...
//            $this->parse();
    ...
    public function getFullName()
    {
        ...
        $firstName = (string)$xmlDemo->patient->name->given;
        $lastName = (string)$xmlDemo->patient->name->family;
    ...
    {
        $xmlDemo = $this->xml->recordTarget->patientRole;
        $dob = (string)$xmlDemo->patient->birthTime['value'];
...
//                (string)$entry->procedure->performer->assignedEntity->addr->streetAddressLine
            ];
...
//            $this->procedures[$n]['performer']['country'] = (string)$entry->procedure->performer->assignedEntity->addr->country;
            ...
            if (is_object($entry->procedure->performer->assignedEntity)) {
