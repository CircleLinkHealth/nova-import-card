...
/**
 * CircleLinkHealth\CarePlanModels\Entities\CpmLifestyleUser.
 *
 * @property int                                      $id
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\CarePlanModels\Entities\CpmLifestyle whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\CarePlanModels\Entities\CpmLifestyle whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\CarePlanModels\Entities\CpmLifestyle whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\CarePlanModels\Entities\CpmLifestyle whereUpdatedAt($value)
 * @mixin \Eloquent
