...
```bash
php artisan vendor:publish --provider="CircleLinkHealth\ResponseCache\ResponseCacheServiceProvider"
```
...
return [
     ...
     */
    'cache_profile' => CircleLinkHealth\ResponseCache\CacheProfiles\CacheAllSuccessfulGetRequestsSpatie::class,
...
And finally you should install the provided middlewares `\CircleLinkHealth\ResponseCache\Middlewares\CacheResponse::class` and `\CircleLinkHealth\ResponseCache\Middlewares\DoNotCacheResponse` in the http kernel. 
...
protected $middlewareGroups = [
   'web' => [
       ...
       \CircleLinkHealth\ResponseCache\Middlewares\CacheResponse::class,
   ],
...
protected $routeMiddleware = [
   ...
   'doNotCacheResponse' => \CircleLinkHealth\ResponseCache\Middlewares\DoNotCacheResponse::class,
];
...
The default class that handles these questions is `CircleLinkHealth\ResponseCache\CacheProfiles\CacheAllSuccessfulGetRequestsSpatie`. 

You can create your own cache profile class by implementing the `
CircleLinkHealth\ResponseCache\CacheProfiles\CacheProfile`-interface. Let's take a look at the interface:
...
protected $routeMiddleware = [
   ...
   'cacheResponse' => \CircleLinkHealth\ResponseCache\Middlewares\CacheResponse::class,
];
```
...
`CircleLinkHealth\ResponseCache\Events\ResponseCacheHit`
...
`CircleLinkHealth\ResponseCache\Events\CacheMissed`
...
`CircleLinkHealth\ResponseCache\Events\ClearingResponseCache`

`CircleLinkHealth\ResponseCache\Events\ClearedResponseCache`
