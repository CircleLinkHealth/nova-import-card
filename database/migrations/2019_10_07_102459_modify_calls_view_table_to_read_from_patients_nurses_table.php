...
class ModifyCallsViewTableToReadFromPatientsNursesTable extends Migration
{
    /**
    ...
    public function down()
    {
        ...
        FROM 
            ...
            left join (select pi.user_id as patient_id, u.id as patient_nurse_id, CONCAT(u.first_name, ' ', u.last_name, ' ', (if (u.suffix is null, '', u.suffix))) as patient_nurse from users u join patient_info pi on u.id = pi.nurse_user_id where u.deleted_at is null) as u9 on c.inbound_cpm_id = u9.patient_id
