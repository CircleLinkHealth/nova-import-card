...
class CreateLvPageTimerTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('lv_page_timer', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->dateTime('actual_start_time')->default('0000-00-00 00:00:00');
            $table->dateTime('end_time')->default('0000-00-00 00:00:00');
            $table->dateTime('actual_end_time')->default('0000-00-00 00:00:00');
