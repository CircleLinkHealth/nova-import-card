    ...
    public function run()
    {
        ...
        */
        ...
        foreach($users as $user) {
            ...
            $existingItems = CcdAllergy::where('patient_id', '=', $user->ID)->get();
            if($existingItems->count() == 1) {
                ...
                echo 'User already has more than 1 Allergen item:' . PHP_EOL;
            }


            $existingItems = CcdProblem::where('patient_id', '=', $user->ID)->get();
            if($existingItems->count() == 1) {
                ...
                echo 'User already has more than 1 Problem item:' . PHP_EOL;
            }


            $existingItems = CcdMedication::where('patient_id', '=', $user->ID)->get();
            if($existingItems->count() == 1) {
                ...
                echo 'User already has more than 1 Medication item:' . PHP_EOL;
            }
        }
    }
