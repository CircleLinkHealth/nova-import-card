...
class EligibilityProcessingTest extends TestCase
{
    public function test_it_processes_phx_heart_record()
    {
        ...
        $batch    = $this
            ...
            ->createBatch(EligibilityBatch::TYPE_PHX_DB_TABLES,
                $practice->id, [
        ...
        $list = (new WelcomeCallListGenerator(collect([0 => $data]), false, true, true, true,
            $practice, null, null, $batch, $job));
