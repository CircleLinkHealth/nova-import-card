...
class CreateOpPreloadPreloadFilePlaceholder extends Command
{
    ...
    public function handle()
    {
        ...
        $this->warn('Checking user 1001 '.posix_getpwuid(1001));
        $this->warn('Checking user sbx_user1051 '.posix_getpwuid('sbx_user1051'));
        $this->warn('Checking user www-data '.posix_getpwuid('www-data'));
