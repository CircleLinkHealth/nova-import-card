...
namespace Illuminate\Support\Facades {
        ...
        class Http
        {
             ...
             *
             * @param  string                                                                         $url
             * @param  callable|\GuzzleHttp\Promise\PromiseInterface|\Illuminate\Http\Client\Response $callback
             * @return \Illuminate\Http\Client\Factory
             * @static
             */
...
namespace Laravel\Nova\Fields {
        ...
        {
            /**
             * @see \App\Providers\NovaServiceProvider::boot()
             * @param mixed $rules
             * @static
             */
            public static function inputRules($rules)
            {
                return \Laravel\Nova\Fields\Field::inputRules($rules);
            }
             ...
             * @static
             */
            public static function withModel($model, $modelKey = null)
            {
                return \Laravel\Nova\Fields\Field::withModel($model, $modelKey);
            }
        }
}
