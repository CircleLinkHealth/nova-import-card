                                ...
                                @foreach( $wpUsers as $wpUser )
                                    <tr>
                                        <td><input class="user-select-checkbox" type="checkbox" name="users[]"
                                                   value="{{ $wpUser->id }}"></td>
                                        <td>
                                            @if(!CircleLinkHealth\CpmAdmin\Http\Controllers\SuperAdmin\UserController::hideFromAdminPanel($wpUser))
                                        ...
                                        <td class="text-right">
                                            @if(!CircleLinkHealth\CpmAdmin\Http\Controllers\SuperAdmin\UserController::hideFromAdminPanel($wpUser) && auth()->user()->hasPermission('user.update'))
                                                <a href="{{ route('admin.users.edit', array('id' => $wpUser->id)) }}"
                                            ...
                                            @if($wpUser->isParticipant())
                                                <a href="{{ config('core.apps.cpm-provider.url').'manage-patients/'.$wpUser->id.'/view-careplan' }}"
