...
class CareAmbassadorTimeTest extends CustomerTestCase
{
    ...
    public function test_time_is_added_in_total_time_in_system()
    {
        ...
        $this->addTime($ca, $enrollee->user, 1, false, false, null, null, 0, self::ACTIVITY_TITLE_LOADING_PATIENT);
        $this->addTime($ca, $enrollee->user, 10, false, false, null, null, $enrollee->id, "CA - $enrollee->id");
        $this->addTime($ca, $enrollee->user, 1, false, false, null, null, 0, self::ACTIVITY_TITLE_TO_SKIP_FROM_CA_TIME, true);
