                        ...
                        @if(!$isTwoFaRoute && ! auth()->user()->isCallbacksAdmin())
                            ...
                            @if($user->hasRole('saas-admin') || $user->isAdmin() || $user->hasRole('saas-admin-view-only'))
                                ...
                                <li class="dropdown-toggle">
                                    ...
                                    <ul class="dropdown-menu" role="menu" style="background: white !important;">
                                        <li>
                                            <a href="{{ route('saas-admin.practices.create')}}">
                                                Add New
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('saas-admin.practices.index')}}">
                                                Manage
                                            </a>
                                        </li>
                                        <li>
                            ...
                            @if($user->isClhCcmAdmin())
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" style="background: white !important;">
                                        ...
                                        <li>
                                            <a href="{{ route('hospitalisation-notes-dashboard.view') }}">
                                                Hospitalization notes dashboard
                                            </a>
                                        </li>
                                        <li>
