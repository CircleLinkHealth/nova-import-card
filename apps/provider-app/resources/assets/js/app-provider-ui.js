...
import {BindWindowFocusChange, BindWindowVisibilityChange} from 'SharedVueComponents/Resources/assets/js/admin/time-tracker/events/window.event'
...
const Select2Component = () => import(/* webpackChunkName: "chunk-provider" */ 'SharedVueComponents/Resources/assets/js/components/src/select2')
const FabComponent = () => import(/* webpackChunkName: "chunk-provider" */ './components/fab')
const OpenModalComponent = () => import(/* webpackChunkName: "chunk-provider" */ 'SharedVueComponents/Resources/assets/js/components/shared/open-modal')
...
const NurseDailyHours = () => import(/* webpackChunkName: "chunk-careplan" */ 'SharedVueComponents/Resources/assets/js/components/pages/work-schedule/daily-hours')
const QuestionnaireApp = () => import(/* webpackChunkName: "chunk-careplan" */ 'SharedVueComponents/Resources/assets/js/admin/questionnaire/app')
const TimeTracker = () => import(/* webpackChunkName: "chunk-provider" */ 'SharedVueComponents/Resources/assets/js/admin/time-tracker')
const TimeTrackerCallModeComponent = () => import(/* webpackChunkName: "chunk-provider" */ 'SharedVueComponents/Resources/assets/js/admin/time-tracker/time-tracker-call-mode')
const ServerTimeDisplay = () => import(/* webpackChunkName: "chunk-careplan" */ 'SharedVueComponents/Resources/assets/js/admin/time-tracker/comps/server-time-display')
const TimeDisplayAllChargeableServicesStatic = () => import(/* webpackChunkName: "chunk" */ 'SharedVueComponents/Resources/assets/js/admin/time-tracker/comps/time-display-all-chargeable-services-static')
const LoaderComponent = () => import(/* webpackChunkName: "chunk-provider" */ 'SharedVueComponents/Resources/assets/js/components/loader')
...
const UserAccountSettings = () => import(/* webpackChunkName: "chunk-provider" */ 'TwoFA/Resources/assets/js/user-account-settings');
const AuthyPerform2FA = () => import(/* webpackChunkName: "chunk-provider" */ 'TwoFA/Resources/assets/js/authy-perform-2fa');
...
const NurseScheduleCalendar = () => import(/* webpackChunkName: "chunk-nurse" */ 'SharedVueComponents/Resources/assets/js/admin/NursesWorkSchedules/NurseScheduleCalendar');
const CalendarLoader = () => import(/* webpackChunkName: "chunk-nurse" */ 'SharedVueComponents/Resources/assets/js/admin/NursesWorkSchedules/FullScreenLoader');
