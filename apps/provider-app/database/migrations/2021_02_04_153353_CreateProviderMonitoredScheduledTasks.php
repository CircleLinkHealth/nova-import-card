...
class CreateProviderMonitoredScheduledTasks extends Migration
{
    public function up()
    {
        DB::statement('SET FOREIGN_KEY_CHECKS = 0');

        if (Schema::hasTable('monitored_scheduled_task_log_items')) {
            Schema::drop('monitored_scheduled_task_log_items');
        }

        if (Schema::hasTable('monitored_scheduled_tasks')) {
            Schema::drop('monitored_scheduled_tasks');
        }
