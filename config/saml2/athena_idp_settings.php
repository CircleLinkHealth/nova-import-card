...
return $settings = [
    ...
    'idp' => [
        ...
        'x509cert' => env('SAML2_'.$this_idp_env_id.'_IDP_X509', null),
        /*
    ...
    'contactPerson' => [
        'technical' => [
            'givenName'    => 'Pangratios Cosma',
            'emailAddress' => 'pangratios@circlelinkhealth.com',
        ],
        'support' => [
            'givenName'    => 'Pangratios Cosma',
            'emailAddress' => 'pangratios@circlelinkhealth.com',
    ...
    'organization' => [
        'en-US' => [
            ...
            'displayname' => 'CircleLink Health',
            'url'         => 'https://www.circlelinkhealth.com',
        ],
    ],
