...
/*!***************************************************************************************!*\
  !*** /Users/michalis/Code/Antonis/cpm-web/node_modules/vue-select/dist/vue-select.js ***!
  \***************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    setPracticesForDropdown: function setPracticesForDropdown() {
      var _this = this;

      this.loading = true;
      Nova.request().get('/nova-vendor/invoices-download/dropdown-practices').then(function (response) {
        _this.practices = response.data;
    ...
    downloadInvoices: function downloadInvoices() {
      ...
      Nova.request().post('/nova-vendor/invoices-download/download', {
        ...
        _this2.$toasted.error(error.response.data);

        _this2.loading = false;
      });
    },
    setMonthsForDropdown: function setMonthsForDropdown() {
      var dateStart = moment(limitDate);
      var dateEnd = moment();
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "px-3 py-3" }, [
        _c("h4", { staticClass: "text-center text-3xl text-80 font-light" }, [
          _vm._v("Invoices Download")
        ]),
        _vm._v(" "),
        _c(
          "div",
          { staticClass: "py-2" },
          [
            _vm.loading ? _c("loader", { attrs: { width: "30" } }) : _vm._e(),
            _vm._v(" "),
              ...
              _c(
                ...
                [
                  _c("vue-select", {
                    ...
                    model: {
                      value: _vm.practicesSelected,
                      callback: function($$v) {
                        _vm.practicesSelected = $$v
                      },
                      expression: "practicesSelected"
                    }
                  })
                ],
                1
              ...
              _c(
                ...
                [
                  _c("vue-select", {
                    ...
                    model: {
                      value: _vm.formatsSelected,
                      callback: function($$v) {
                        _vm.formatsSelected = $$v
                      },
                      expression: "formatsSelected"
                    }
                  })
                ],
                1
...
Nova.booting(function (Vue, router, store) {
  Vue.component('invoices-download', __webpack_require__(/*! ./components/Card */ "./resources/js/components/Card.vue")["default"]);
});
...
__webpack_require__(/*! /Users/michalis/Code/Antonis/cpm-web/nova-components/InvoicesDownload/resources/js/card.js */"./resources/js/card.js");
module.exports = __webpack_require__(/*! /Users/michalis/Code/Antonis/cpm-web/nova-components/InvoicesDownload/resources/sass/card.scss */"./resources/sass/card.scss");
