<div>
    ...
    <p>
        ...
        whichever you prefer  to check on how you’re doing, or to see if you’re having any new problems.
        And then the nurse would report back to @{{provider_name}} so that s/he would have that information in his/her records.
        This helps the doctor keep up a little better with how you’re doing in between visits and keeps them updated on your medications
        and vitals (such as blood pressures and blood sugars).
    </p>

    <p>
        The program is offered through Medicare and  it’s no cost if you have supplemental insurance to cover a small ~$8 copay. So I was just calling
    ...
    <p>
        ...
        <br>“It is easy to cancel if you just want to try it for a month or two and see how it goes.
        All you would have to do is just let the nurse know that you don’t want to continue and we will take your name back off of the list.”
