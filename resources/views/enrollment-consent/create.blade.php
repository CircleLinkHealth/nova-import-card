                    ...
                    <dialog id="dialog" class="mdl-dialog" style="width: 80%">
                        ...
                        <div class="mdl-dialog__content" style="">
                            <ul class="mdl-list">
                                ...
                                <li class="mdl-list__item">All the information we collect is private, securely
                                    stored
                                    and communicated, and
                                    available to your
                                    doctor and care team
                                <li class="mdl-list__item">You can withdraw at any time you want. Just give us a
                                    call!
                                </li>
                            </ul>
                        </div>
