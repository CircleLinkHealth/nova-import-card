...
<div class="row">
    <a href="{{ route('admin.items.show', array('id' => $carePlan->id)) }}" class="btn btn-primary btn-xs section-reload" section="{{ $careSection->id }}">Refresh</a>
    ...
    <a href="{{ route('admin.items.show', array('id' => $carePlan->id)) }}" class="btn btn-orange btn-xs section-reload" section="{{ $careSection->id }}">Add Item</a>
</div>
