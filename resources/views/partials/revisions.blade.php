                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseRev{{ $history->id }}" class="panel-collapse collapse">
                            <div class="panel-body">
                                ...
                                <h4>After:</h4><strong>{{ (strlen($history->newValue()) > 30) ? substr($history->newValue(),0,1000).'...' : $history->newValue() }}</strong>
                            </div>
                        </div>
                    </div>
                @endforeach
