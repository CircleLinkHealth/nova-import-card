<div class="container">
    ...
    <br>
    <p>
        To avoid further confusion, we will be removing the other metrics until we can get accurate numbers to you.
        <br>
        Please reach out to Ethan if you would like to know a certain metric.
    </p>
    {{--    <p>&nbsp;</p>--}}
    {{--    <ol start="3">--}}
    ...
    {{--    </ol>--}}
    {{--    <ul>--}}
    {{--        <li>Average CCM time per successful patient: {{$avgCCMTimePerPatient}} minutes (goal is to stay as close to 20 minutes as possible)</li>--}}
    {{--        <ul>--}}
    {{--            <li>Calculated by dividing your total CCM time on successful patients by the total amount of completed patients for the month</li>--}}
    {{--        </ul>--}}
    ...
    {{--        <ul>--}}
    {{--            <li>Calculated by multiplying the average time to complete a patient (above) by total remaining patients and dividing by 60 minutes to get an hour total</li>--}}
    {{--        </ul>--}}
