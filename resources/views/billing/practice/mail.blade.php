...
<p>For paying CircleLink and billing Medicare, i) a CircleLink invoice for the most recent month is attached and ii) a Medicare billing report can be downloaded <a href="{{$link}}"> here</a>. (Login required)
