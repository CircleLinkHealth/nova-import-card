    ...
    <div class="btn-group btn-group-justified" role="group" aria-label="...">
        <div class="btn-group" role="group">
            <button type="button"
                ...
                <span class="btn-number">1</span> <span class="btn-text">Patient Contact</span></button>
        </div>
        <div class="btn-group" role="group">
            <button type="button"
        ...
        <div class="btn-group" role="group">
            <button type="button"
                    dtarget="{{ URL::route('patient.careplan.show', array('patientId' => $patient->id)) }}"
                    class="btn btn-primary submitFormBtn @if(Route::is('patient.careplan.show')) active @endif"
        ...
        <div class="btn-group" role="group">
            <button type="button"
                    dtarget="{{ URL::route('patient.careplan.show', array('patientId' => $patient->id)) }}"
                    class="btn btn-primary submitFormBtn @if(Route::is('patient.careplan.show')) active @endif"><span
                        class="btn-number">5</span> <span class="btn-text">Symptoms/Other</span></button>
        </div>
    </div>
</div>