...
<div class="main-form-progress">
    <div class="row row-centered">
        @if($patient->getCareplanMode() == CircleLinkHealth\CarePlanModels\Entities\CarePlan::PDF)
        ...
        @if($patient->getCareplanMode() == CircleLinkHealth\CarePlanModels\Entities\CarePlan::WEB)
            @if(isset($patient->id))
                <div class="progress-buttons col-sm-12 col-centered text-center">
