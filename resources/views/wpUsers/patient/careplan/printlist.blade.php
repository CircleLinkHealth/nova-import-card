                    ...
                    <script>
                        ...
                        obs_alerts_dtable = new webix.ui({
                            ...
                            columns:[
                                ...
                                { id:"last_name",   header:["Patient Name",{content:"textFilter", placeholder:"Filter"}], template:"<a href='<?php echo URL::route('patient.summary', array('patient' => '#key#')); ?>'>#first_name# #last_name#</a>", width:120, sort:'string',adjust:true, fillspace:true},
