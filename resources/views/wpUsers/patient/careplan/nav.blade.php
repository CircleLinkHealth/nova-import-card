...
<div class="edit-navigation-buttons col-lg-10 col-lg-offset-1">
    <div class="btn-group btn-group-justified" role="group" aria-label="...">
        <div class="btn-group" role="group">
            <button type="button" dtarget="{{ URL::route('patient.edit.show', array('patientId' => $patient->ID)) }}" class="btn btn-primary submitFormBtn @if(Route::is('patient.edit.show')) active @endif"><span class="btn-number">1</span> <span class="btn-text">Patient Contact</span></button>
        </div>
        <div class="btn-group" role="group">
        ...
        <div class="btn-group" role="group">
            <button type="button" dtarget="{{ URL::route('patient.edit.show', array('patientId' => $patient->ID)) }}" class="btn btn-primary submitFormBtn @if(Route::is('patient.edit.show')) - @endif"><span class="btn-number">5</span> <span class="btn-text">Symptoms/Other</span></button>
        </div>
    </div>
</div>