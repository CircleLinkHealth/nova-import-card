<div class="edit-navigation-buttons col-lg-10 col-lg-offset-1">
    ...
    <div class="btn-group btn-group-justified" role="group" aria-label="...">
        ...
        <div class="btn-group" role="group">
            <button type="button"
                    dtarget="{{ route('patient.careplan.show', array('patientId' => $patient->id, 'page' => 1)) }}"
                ...
                <span class="btn-number">2</span> <span class="btn-text">Patient Monitors I</span></button>
        </div>
        <div class="btn-group" role="group">
            <button type="button"
                    dtarget="{{ route('patient.careplan.show', array('patientId' => $patient->id, 'page' => 2)) }}"
                    ...
                    data-toggle="tooltip" data-placement="top" title="Biometrics and Transitional Care"><span
                        class="btn-number">3</span> <span class="btn-text">Patient Monitors II</span></button>
        </div>
        <div class="btn-group" role="group">
            <button type="button"
                    dtarget="{{ route('patient.careplan.show', array('patientId' => $patient->id, 'page' => 3)) }}"
                    class="btn btn-primary submitFormBtn @if(Route::is('patient.careplan.show') && isset($page) && $page == 3) active @endif">
                <span class="btn-number">4</span> <span class="btn-text">Symptoms/Other</span></button>
        </div>
    </div>
</div>