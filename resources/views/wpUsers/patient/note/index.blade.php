    ...
    <div class="row main-form-block" style="margin-top:30px;">
        <div class="main-form-container col-lg-10 col-lg-offset-1 col-xs-12">
            <div class="row">
                ...
                @if((! auth()->user()->isCareCoach() && auth()->user()->hasPermission('note.create')) || (auth()->user()->isCareCoach() && app(CircleLinkHealth\Customer\Policies\CreateNoteForPatient::class)->can(auth()->id(), $patient->id)))
