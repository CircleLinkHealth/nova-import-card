                ...
                <div class="main-form-block main-form-horizontal main-form-primary-horizontal col-md-12">
                    ...
                    <script>
                        ...
                        obs_alerts_dtable = new webix.ui({
                            ...
                            //tooltip:true,
                            columns:[
                                { id:"first_name",   header:["Patient Name",{content:"textFilter", placeholder:"Filter"}], template:"<a href='<?php echo URL::route('patient.summary', array('patient' => '#key#')); ?>'>#first_name# #last_name#</a>", width:150, sort:'string'},
                                { id:"last_name",   header:["Patient Name",{content:"textFilter", placeholder:"Filter"}], template:"<a href='<?php echo URL::route('patient.summary', array('patient' => '#key#')); ?>'>#last_name#, #first_name#</a>", width:150, sort:'string'},
