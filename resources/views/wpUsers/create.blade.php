                            ...
                            <div role="tabpanel" class="tab-pane active" id="program">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-4">{!! Form::select('careplan_status', array('draft' => 'draft', 'clh_approved' => 'clh_approved', 'provider_approved' => 'provider_approved'), '', ['class' => 'form-control select-picker', 'style' => 'width:40%;']) !!}</div>
                                    </div>
                                </div>
