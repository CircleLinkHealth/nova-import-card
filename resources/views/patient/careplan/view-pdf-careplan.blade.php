    ...
    <div id="v-pdf-careplans" class="container">
        ...
        <pdf-careplans mode="pdf">
            <template slot="buttons">
                @if(auth()->user()->hasRole(['administrator', 'provider', 'office_admin', 'med_assistant', 'registered-nurse']) && $patient->carePlan && $patient->carePlan->mode == CircleLinkHealth\CarePlanModels\Entities\CarePlan::PDF)
