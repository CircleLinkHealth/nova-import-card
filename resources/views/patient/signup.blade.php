    ...
    <div class="content">
        <div class="header row">
            <div class="col s12">
                ...
                <div class="col s2">
                    <a class="waves-effect waves-light btn-large blue">Sing me up</a>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col s4">
                    <div class="center promo promo-picture">
                        <img class="col s12" src="{{asset('/img/landing-pages/registered-nurse.png')}}" alt="">
                        <p class="promo-caption">Fully Registered Nurse Care Coach</p>
                        <p class="light center">Our trained nurses guide you to wellness while taking the stress off
                ...
                <div class="col s4">
                    <div class="center promo promo-picture">
                        ...
                        <p class="light center">Our nurses formulate a care plan based on doctor’s orders and we provide
                            unlimited access to wellness and diet content/education materials.</p>
                    </div>
                </div>
                <div class="col s4">
                    <div class="center promo promo-picture">
                        <img class="col s12" src="{{asset('/img/landing-pages/coordination-with-family.png')}}" alt="">
                        <p class="promo-caption">Coordination with Family and Doctors</p>
                        <p class="light center">Family members can stay at ease with real-time updates from our system
