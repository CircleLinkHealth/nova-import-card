                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                @if(Cerberus::hasPermission('observation.update'))
                                    <a href="{{ route('admin.comments.edit', array('id' => $comment->id)) }}" class="btn btn-primary">Edit</a> <a href="{{ route('admin.comments.destroy', array('id' => $comment->id)) }}" class="btn btn-warning">Remove</a>
                                @endif
                                </td>
                            </tr>
                            </tbody>
