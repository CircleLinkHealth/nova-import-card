        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">EDIT {{ $role->rule_name }}</div>
                    <div class="panel-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td><a href="{{ url('roles/'.$role->id.'') }}" class="btn btn-primary">{{ $role->id }} Detail</a></td>
                                    <td>{{ $role->name }}</td>
                        ...
                        @foreach( $permissions as $permission )
                            <div class="form-group condition" id="perm_{{ $permission }}">
                                <div class="col-sm-1">{!! Form::label('Value', 'Permission:', array('class' => '')) !!}</div>
                                <div class="col-sm-3">
