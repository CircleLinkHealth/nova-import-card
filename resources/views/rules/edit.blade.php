...
@section('content')
    ...
    {!! Form::open(array('url' => route('admin.rules.update', array('id' => $rule->id)), 'class' => 'form-horizontal')) !!}
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td><a href="{{ route('admin.rules.show', array('id' => $rule->id)) }}" class="btn btn-primary">{{ $rule->id }} Detail</a></td>
