            ...
            if (this.isEnrollees) {
                axios.post(`/survey/${this.surveyName}/get-enrollable-data`, {
                    ...
                    .then((response) => {
                        ...
                        this.enrollmentSurveyPatients.emails.patientEmail = data.patientEmail;
                        this.enrollmentSurveyPatients.emails.patientAutoGeneratedEmail = data.patientAutoGeneratedEmail;
