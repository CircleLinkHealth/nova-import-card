...
<script>
    ...
    export default {
        ...
        props: ['question', 'userId', 'surveyInstanceId', 'showNextButton', 'isSubQuestion', 'onDoneFunc', 'styleHorizontal', 'getAllQuestionsFunc', 'isLastQuestion'],
        components: {mdbBtn},
