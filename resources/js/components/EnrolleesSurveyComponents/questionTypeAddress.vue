    ...
    export default {
        ...
        methods: {
            ...
            handleAnswer() {
                ...
                if (this.isMultiInput) {
                    ...
                    if(value === ''){
                            value = this.enrollmentSurveyPatients.emails;
                    }
        ...
        created() {
            if (this.question.identifier === 'Q_CONFIRM_EMAIL') {
                this.singleInputHasText = this.enrollmentSurveyPatients.emails.patientAutoGeneratedEmail !== ''
                ? ''
                : this.enrollmentSurveyPatients.emails.patientEmail;
            }
