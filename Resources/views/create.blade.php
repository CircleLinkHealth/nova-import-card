        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">Billable Patient Report Generator (Only shows approved patients > 20
                        minutes)
                    </div>
                                    ...
                                    <select id="practices" name="practices[]"
                                        ...
                                        @foreach($readyToBill as $practice)
                                            <option value="{{$practice->id}}"
                                                    @if(auth()->user()->isAdmin() && $practice->isARealBillableCustomer()) selected @endif>{{$practice->display_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
