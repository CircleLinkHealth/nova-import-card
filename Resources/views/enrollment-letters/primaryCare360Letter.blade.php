...
@section('title', 'Primary Care 360 Invitation')
@section('activity', 'Primary Care 360 Invitation')
@section('content')
    <div class="container">
        <div class="letter-view">
            ...
            @include('selfEnrollment::enrollment-letters.headers.primary-care-360')
