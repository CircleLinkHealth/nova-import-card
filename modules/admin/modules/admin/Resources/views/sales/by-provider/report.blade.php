@extends('cpm-admin::sales.partials.report-layout')

<?php

$enrollmentSection = \CircleLinkHealth\CpmAdmin\Reports\Sales\Provider\Sections\EnrollmentSummary::class;
$rangeSection      = \CircleLinkHealth\CpmAdmin\Reports\Sales\Provider\Sections\RangeSummary::class;
$financialSection  = \CircleLinkHealth\CpmAdmin\Reports\Sales\Provider\Sections\FinancialSummary::class;
$practiceSection   = \CircleLinkHealth\CpmAdmin\Reports\Sales\Provider\Sections\PracticeDemographics::class;
...
@section('content')
    ...
    @if(array_key_exists($enrollmentSection, $data))
        ...
        @include('cpm-admin::sales.partials.enrollement-section', ['data' => $data])

    @endif

    @if(array_key_exists($financialSection, $data))

        @include('cpm-admin::sales.partials.financial-section', ['data' => $data])

    @endif

    @if(array_key_exists($practiceSection, $data))

        @include('cpm-admin::sales.partials.practice-section', ['data' => $data])
