                            ...
                            <div class="panel-body">
                                ...
                                @if(optional($initiatorUser)->hasRole('ehr-report-writer'))
                                    <div class="pull-right" style="padding-left: 2%;">
                                        <button class="btn btn-primary" onclick="notifyReportWriter()">Notify Report
                                            Writer
                                        </button>
                                    </div>
                                @endif
                                ...
                                <div class="row">
                                    @if (CircleLinkHealth\SharedModels\Entities\EligibilityBatch::ATHENA_API == $batch->type)
                                        <div class="col-md-12">ELIGIBLES ARE PATIENTS W/ OFFICE VISIT IN LAST 12 MONTHS
                                            SINCE BATCH START DATE
                                        </div>
                                    @endif
                                    <div class="col-md-4">
                                        <h4>Counts</h4>
                                        ...
                                        @if(isset($stats) && !empty($stats))
                                            @forelse($stats as $key => $value)
                                                <b>{{snakeToSentenceCase(\Illuminate\Support\Str::snake($key))}}</b>
                                                : {{$value}}<br>
                                            @empty
                                                <p>No stats found</p>
                                            @endforelse
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        Total records with invalid data
                                        structure: {{$validationStats['invalid_structure']}}<br>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        @forelse($batch->options as $k => $option)
                                            ...
                                            @if(!is_array($option))
                                                ...
                                                : @if(is_bool($option)) {{!!$option ? 'Yes' : 'No'}} @else {{$option}} @endif
                                                <br>
                                            @endif
                                        @empty
                                        ...
                                        <div class="col-md-4">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <p>Finished Processing at: <span style="color: forestgreen;">{{presentDate($media->getCustomProperty(\CircleLinkHealth\Eligibility\Importers\PracticePull\AbstractImporter::FINISHED_PROCESSING_AT_LABEL, null))}}</span></p>
