            ...
            <form action="{{ route('post.eligibility.reprocess', [$batch->id]) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="" type="radio" name="reprocessingMethod" id="reprocessingMethod"
                           value="{{CircleLinkHealth\SharedModels\Entities\EligibilityBatch::REPROCESS_SAFE}}" checked>
                    ...
                    <input class="" type="radio" name="reprocessingMethod" id="reprocessingMethod"
                           value="{{CircleLinkHealth\SharedModels\Entities\EligibilityBatch::REPROCESS_FROM_SCRATCH}}">
