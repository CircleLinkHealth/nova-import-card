...
class CopyChangesToPppTaskRec extends Migration
{
    /**
    ...
    public function up()
    {
        ...
        $dataToUpdate = [
            ...
            'Recreational Drug use' => json_encode([
                [
...
If you cannot do this because of chronic conditions, be as physically active as their abilities and conditions safely allow.',
            ...
            'Hearing Impairment' => json_encode([
                [
            ...
            'Cognitive Impairment:' => json_encode([
                [
            ...
            'Immunizations/Vaccines:' => json_encode([
                // Flu/Influenza
                [
