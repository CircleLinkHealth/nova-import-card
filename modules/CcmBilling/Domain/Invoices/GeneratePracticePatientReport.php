...
class GeneratePracticePatientReport
{
    ...
    private function setCodes(PracticePatientReportData $result)
    {
        ...
        $ccmProblems                = PatientProblemsForBillingProcessing::getForCodes($this->billingStatus->patient_user_id, [ChargeableService::RPM,ChargeableService::CCM, ChargeableService::PCM, ChargeableService::GENERAL_CARE_MANAGEMENT]);
