 ...
 * @method   static                                                                                      \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\SharedModels\Entities\ActivityMeta newModelQuery()
 * @method   static                                                                                      \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\SharedModels\Entities\ActivityMeta newQuery()
 * @method   static                                                                                      \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\SharedModels\Entities\ActivityMeta query()
...
class ActivityMeta extends \CircleLinkHealth\Core\Entities\BaseModel
{
    ...
    {
        return $this->belongsTo('CircleLinkHealth\SharedModels\Entities\Activity');
    }
}
