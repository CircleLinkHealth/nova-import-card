 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\SharedModels\Entities\PageTimer
 *     createdInMonth(\Carbon\Carbon $date, $field = 'created_at')
 * @method static \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\SharedModels\Entities\PageTimer
 *     newModelQuery()
 * @method static                                                                       \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\SharedModels\Entities\PageTimer newQuery()
 * @method static                                                                       \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\SharedModels\Entities\PageTimer query()
 ...
 * @method static                                                                       \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\SharedModels\Entities\PageTimer whereEnrolleeId($value)
...
class PageTimer extends \CircleLinkHealth\Core\Entities\BaseModel
{
    ...
    {
        return $this->hasMany(Activity::class, 'page_timer_id');
    }

    public function activity()
    {
        return $this->belongsTo(Activity::class, 'id', 'page_timer_id');
    }
