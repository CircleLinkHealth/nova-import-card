 ...
 * @property \CircleLinkHealth\SharedModels\Entities\Comment                                                    $comment
 ...
 * @property \CircleLinkHealth\SharedModels\Entities\ObservationMeta[]|\Illuminate\Database\Eloquent\Collection $meta
...
class Observation extends BaseModel
{
    ...
    {
        return $this->belongsTo(\CircleLinkHealth\SharedModels\Entities\Comment::class);
    }
    ...
    {
        return \App\Observation::where('obs_id', '=', $obs_id)->get();
    }
