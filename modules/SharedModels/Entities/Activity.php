 ...
 * @property \CircleLinkHealth\SharedModels\Entities\ActivityMeta[]|\Illuminate\Database\Eloquent\Collection $meta
 * @property \CircleLinkHealth\SharedModels\Entities\PageTimer                                               $pageTime
 ...
 * @mixin \Eloquent
 * @method static \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\SharedModels\Entities\Activity
 *     createdInMonth(\Carbon\Carbon $date, $field = 'created_at')
 * @method static \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\SharedModels\Entities\Activity
 *     newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\SharedModels\Entities\Activity newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\SharedModels\Entities\Activity query()
 * @method static \Illuminate\Database\Eloquent\Builder|\CircleLinkHealth\SharedModels\Entities\Activity
...
class Activity extends BaseModel
{
    ...
    public static function getReportData(
        ...
        $data = $query
            ->whereIn('patient_id', function ($subQuery) {
