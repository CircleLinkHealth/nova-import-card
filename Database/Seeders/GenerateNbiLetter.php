...
class GenerateNbiLetter extends Seeder
{
    ...
    private string $customerSignaturePic;
    ...
    public function run()
    {
        ...
        $this->customerSignaturePic = EnrollmentInvitationLetter::CUSTOMER_SIGNATURE_PIC;

        $nbiPractice = $this->getPractice();

        $bodyPageOne = $this->pageOne();
    ...
    private function pageTwo()
    {
        ...
        <p><strong>What is the Beth Care Coordination program?</strong></p>
    ...
    {
        $phoneNumber = $this->practiceNumber;
        return "<p><strong>What are the benefits of signing up for the Beth Care Coordination program?</strong></p>
