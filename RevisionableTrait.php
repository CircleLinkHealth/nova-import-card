...
namespace CircleLinkHealth\Revisionable;
...
trait RevisionableTrait
{
    ...
    public function postCreate()
    {
        ...
        if (( ! isset($this->revisionEnabled) || $this->revisionEnabled)) {
            ...
            StoreRevisions::dispatch($revision)->onQueue(config('revisionable.queue'));
        }
    }
    ...
    public function postSave()
    {
        ...
        if ((( ! isset($this->revisionEnabled) || $this->revisionEnabled) && $this->updating) && ( ! $LimitReached || $RevisionCleanup)) {
            ...
            if (count($revisions) > 0) {
                ...
                StoreRevisions::dispatch($revisions)->onQueue(config('revisionable.queue'));
            }
        }
    }
