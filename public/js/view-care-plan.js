...
// devtools global hook
        ...
        var carePerson = Vue.component('carePerson', {
            ...
            methods: {
                deleteCareTeamMember: function deleteCareTeamMember(id) {
                    var disassociate = confirm('Are you sure you want to remove ' + this.care_person.user.first_name + ' ' + this.care_person.user.last_name + ' from the CareTeam?');
                ...
                editCareTeamMember: function editCareTeamMember(id) {
                    $("#editCareTeamModal-" + id).modal();
                },

                updateCareTeamMember: function updateCareTeamMember(id) {
    ...
    }, {"vue": 3, "vue-resource": 2}], 5: [function (require, module, exports) {
        'use strict';
        ...
        var vm = new Vue({
            ...
            methods: {
                createCarePerson: function createCarePerson() {
                    var id = 'new' + parseInt(Math.random() * 100, 10);
        ...
        "./components/CareTeam/care-person.js": 4,
        "./components/CareTeam/search-providers.js": 5,
        "vue": 3,
        "vue-resource": 2
    }]
}, {}, [6]);

//# sourceMappingURL=view-care-plan.js.map
