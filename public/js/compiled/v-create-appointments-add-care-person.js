...
Vue.component('createAppointmentsAddCarePerson', __webpack_require__(94));
...
var getPatientCarePlan = function getPatientCarePlan(_ref12, patientId) {
    ...
    __WEBPACK_IMPORTED_MODULE_4__api_patient_care_plan__["a" /* default */].getPatientCareplan(function (carePlan) {
        if (!carePlan) {
...
var update = __webpack_require__(5)("6089f58b", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js?sourceMap!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c554be10\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./modal.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js?sourceMap!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c554be10\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./modal.vue");
...
// module
exports.push([module.i, "\n.close-button {\n    font-size: 25px;\n    font-weight: 100;\n    color: tomato;\n    position: absolute;\n    top: 15px;\n    left: 25px;\n    cursor: pointer;\n}\n.vue-modal-mask {\n    position: fixed;\n    z-index: 1050;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    background-color: rgba(0, 0, 0, .5);\n    display: table;\n    transition: opacity .3s ease;\n}\n.vue-modal-wrapper {\n    display: table-cell;\n    vertical-align: middle;\n}\n@media ( min-width: 768px) {\n.vue-modal-container {\n        width: 50%;\n        min-width: 430px;\n}\n}\n.vue-modal-container {\n    margin: 0px auto;\n    padding: 20px 30px;\n    background-color: #fff;\n    border-radius: 4px;\n    box-shadow: 0 2px 8px rgba(0, 0, 0, .33);\n    transition: all .3s ease;\n    font-family: Helvetica, Arial, sans-serif;\n    position: relative;\n    overflow-y: auto;\n    max-height: 100vh;\n\n    font-size: 14rem;\n    color: #7b7d81;\n}\n.vue-modal-header h3 {\n    margin: 0;\n}\n.vue-modal-header, .vue-modal-footer {\n    border: none;\n}\n.vue-modal-default-button {\n    float: right;\n}\n.vue-modal-body {\n    padding: 5px;\n}\n\n/*\n * the following styles are auto-applied to elements with\n * v-transition=\"modal\" when their visiblity is toggled\n * by Vue.js.\n *\n * You can easily play with the modal transition by editing\n * these styles.\n */\n.vue-modal-enter {\n    opacity: 0;\n}\n.vue-modal-leave-active {\n    opacity: 0;\n}\n.vue-modal-enter .vue-modal-container,\n.vue-modal-leave-active .vue-modal-container {\n    -webkit-transform: scale(1.3);\n    transform: scale(1.3);\n}\n", "", {"version":3,"sources":["/Users/michalis/Code/CLH/cpm-api/resources/assets/js/components/shared/modal.vue?b5a6eb4c"],"names":[],"mappings":";AA2BA;IACA,gBAAA;IACA,iBAAA;IACA,cAAA;IACA,mBAAA;IACA,UAAA;IACA,WAAA;IACA,gBAAA;CACA;AAEA;IACA,gBAAA;IACA,cAAA;IACA,OAAA;IACA,QAAA;IACA,YAAA;IACA,aAAA;IACA,oCAAA;IACA,eAAA;IACA,6BAAA;CACA;AAEA;IACA,oBAAA;IACA,uBAAA;CACA;AAEA;AACA;QACA,WAAA;QACA,iBAAA;CACA;CACA;AAEA;IACA,iBAAA;IACA,mBAAA;IACA,uBAAA;IACA,mBAAA;IACA,yCAAA;IACA,yBAAA;IACA,0CAAA;IACA,mBAAA;IACA,iBAAA;IACA,kBAAA;;IAEA,iBAAA;IACA,eAAA;CACA;AAEA;IACA,UAAA;CACA;AAEA;IACA,aAAA;CACA;AAEA;IACA,aAAA;CACA;AAEA;IACA,aAAA;CACA;;AAEA;;;;;;;GAOA;AAEA;IACA,WAAA;CACA;AAEA;IACA,WAAA;CACA;AAEA;;IAEA,8BAAA;IACA,sBAAA;CACA","file":"modal.vue","sourcesContent":["<template>\n    <transition name=\"vue-modal\">\n        <div class=\"vue-modal-mask\">\n            <div class=\"vue-modal-wrapper\">\n                <div class=\"vue-modal-container\">\n                    <div class=\"vue-modal-header\">\n                        <slot name=\"header\">\n                        </slot>\n                    </div>\n                    <div class=\"vue-modal-body\">\n                        <slot name=\"body\">\n                        </slot>\n                    </div>\n                    <div class=\"vue-modal-footer\">\n                        <slot name=\"footer\">\n                        </slot>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </transition>\n</template>\n<script>\n    export default {}\n</script>\n\n<style>\n    .close-button {\n        font-size: 25px;\n        font-weight: 100;\n        color: tomato;\n        position: absolute;\n        top: 15px;\n        left: 25px;\n        cursor: pointer;\n    }\n\n    .vue-modal-mask {\n        position: fixed;\n        z-index: 1050;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n        background-color: rgba(0, 0, 0, .5);\n        display: table;\n        transition: opacity .3s ease;\n    }\n\n    .vue-modal-wrapper {\n        display: table-cell;\n        vertical-align: middle;\n    }\n\n    @media ( min-width: 768px) {\n        .vue-modal-container {\n            width: 50%;\n            min-width: 430px;\n        }\n    }\n\n    .vue-modal-container {\n        margin: 0px auto;\n        padding: 20px 30px;\n        background-color: #fff;\n        border-radius: 4px;\n        box-shadow: 0 2px 8px rgba(0, 0, 0, .33);\n        transition: all .3s ease;\n        font-family: Helvetica, Arial, sans-serif;\n        position: relative;\n        overflow-y: auto;\n        max-height: 100vh;\n\n        font-size: 14rem;\n        color: #7b7d81;\n    }\n\n    .vue-modal-header h3 {\n        margin: 0;\n    }\n\n    .vue-modal-header, .vue-modal-footer {\n        border: none;\n    }\n\n    .vue-modal-default-button {\n        float: right;\n    }\n\n    .vue-modal-body {\n        padding: 5px;\n    }\n\n    /*\n     * the following styles are auto-applied to elements with\n     * v-transition=\"modal\" when their visiblity is toggled\n     * by Vue.js.\n     *\n     * You can easily play with the modal transition by editing\n     * these styles.\n     */\n\n    .vue-modal-enter {\n        opacity: 0;\n    }\n\n    .vue-modal-leave-active {\n        opacity: 0;\n    }\n\n    .vue-modal-enter .vue-modal-container,\n    .vue-modal-leave-active .vue-modal-container {\n        -webkit-transform: scale(1.3);\n        transform: scale(1.3);\n    }\n</style>"],"sourceRoot":""}]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("678d71bc", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_modal_vue__ = __webpack_require__(27);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: Object.assign({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["b" /* mapActions */])(['getPatientCareTeam', 'addNotification']), {
...
/******/ });
//# sourceMappingURL=v-create-appointments-add-care-person.js.map