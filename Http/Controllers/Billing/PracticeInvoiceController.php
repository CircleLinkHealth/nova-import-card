...
namespace CircleLinkHealth\CpmAdmin\Http\Controllers\Billing;
...
class PracticeInvoiceController extends Controller
{
    ...
    public function createInvoices()
    {
        ...
        return view('cpm-admin::billing.practice.create', compact(
            [
                'readyToBill',
                'invoice_no',
                'dates',
    ...
    public function make()
    {
        ...
        return view('cpm-admin::admin.reports.billing', compact([
            'cpmProblems',
            'practices',
            'chargeableServices',
            'dates',
